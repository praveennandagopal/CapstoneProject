...
def mongoCollection():      
    ...
    database = mongoDBcon["myYoutubeChannel"]
    collection = database["myYoutubeChannel"]
    return collection
...
if(creating_DB):
    ...
    if _channelId !="":        
        ...
        if checkChannel:
            ...
            st.write("Channel Inserted Successfully")
        else:
            st.write("Channel Already existed")
    
    else:
        st.write("Please Enter Youtube Name")
...
try:
        ...
        st.write("There is No Tables in SQL")  
